...
SpellDamage.attackModifiersList = {
	...
	venomancer_poison_sting = { tickDamage = "damage"; tickDuration = "duration"; tickInterval = 1; starTime = 0; };
	viper_poison_attack = { tickDamage = "damage"; tickDuration = "duration"; tickInterval = 1; starTime = 1; };
}
...
SpellDamage.spellList = {
	...
	viper_viper_strike = { tickDamage = "damage"; tickDuration = "duration"; tickInterval = 1; starTime = 1; }
